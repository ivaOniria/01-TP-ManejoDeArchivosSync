...
function combinarDosArrays(arrA, arrB) {
    const combinados = [...new Set([...arrA, ...arrB])]
    return combinados.sort((a, b) => a - b)
}
...
function combinarNArrays(arrs) {
    const combinados = [...new Set([...arrs.flat()])]
    return combinados.sort((a, b) => a - b)
}

// exportar ambas funciones
export default {
    combDosArr: combinarDosArrays,
    combNArr: combinarNArrays
} 